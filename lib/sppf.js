...
SPPF.IntermediateNode = class extends SPPF.Node {
...
SPPF.PackedNode = class extends SPPF.Node {
...
SPPF.SymbolNode = class extends SPPF.Node {
...
SPPF.RightNullablePartNode = class extends SPPF.Node {
...
SPPF.TerminalNode = class extends SPPF.Node {
...
SPPF.EpsilonNode = class extends SPPF.TerminalNode {
  constructor() {
    super(EPSILON, 0, 0)
  }
...
SPPF.Forest = class {
  ...
  transform() {
    const dead = this.root.transform([
      (node) => {
