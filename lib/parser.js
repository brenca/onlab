  ...
  fromBNF(bnf) {
    ...
    if (nullables.length > 0) {
      ...
      nullables.forEach(rule => {
        const nullableSPPF = new Parser._SPPFSymbolNode(rule, null)
          ...
          while (R.length > 0) { // Reducer
            ...
            paths.fastForEach(path => {
              ...
              if (action.m === 0) {
                ...
                if (!z) {
                  z = new Parser._SPPFSymbolNode(action.rule, c)
                  N.push(z)
                }
              }
